...
[![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 509,098 | 🐛 106 | 📅 2026-09-02
[![All Contributors](https://img.shields.io/badge/all_contributors-43-orange.svg)](https://github.com/thibmaek/awesome-raspberry-pi/blob/main/CONTRIBUTORS.md) ⭐ 16,910 | 🐛 28 | 🌐 Shell | 📅 2026-07-27
...
This list is a collection of tools, projects, images and resources conforming to the [Awesome Manifesto](https://github.com/sindresorhus/awesome/blob/main/awesome.md) ⭐ 509,098 | 🐛 106 | 📅 2026-09-02
...
* [PIrateRF](https://github.com/psyb0t/piraterf) ⭐ 283 | 🐛 0 | 🌐 Go | 📅 2026-08-01 - Turns a Raspberry Pi Zero W into a portable, browser-controlled RF transmitter with its own WiFi hotspot, supporting a dozen modes including FM broadcast, FT8, RTTY, POCSAG, and Morse. ![Supports Raspberry Pi Zero](/media/badges/rpi-0.png)
...
* [Pi-Apps](https://github.com/Botspot/pi-apps) ⭐ 2,816 | 🐛 150 | 🌐 Shell | 📅 2026-09-23 - The most popular app store for Raspberry Pi computers, 100% open-source bash scripts.
...
* [AdGuard Home](https://github.com/AdguardTeam/AdGuardHome) ⭐ 37,031 | 🐛 1,261 | 🌐 TypeScript | 📅 2026-09-22 - DNS relay station with ad/tracker/other blocking, IP address redirections, and DNS-over-HTTPS.
* [Sonic Pi](https://github.com/samaaron/sonic-pi) ⭐ 12,147 | 🐛 32 | 🌐 C++ | 📅 2026-09-20 - The Live Coding Music Synth for Everyone.
* [Pi-KVM](https://github.com/pikvm/pikvm) ⭐ 10,351 | 🐛 89 | 📅 2026-09-21 - DIY KVM over IP to manage remote computers via Web UI or VNC with FullHD video, mouse, virtual drive, IPMI, Wake-on-LAN and many other things.
...
* [Smart Mirror](https://github.com/evancohen/smart-mirror) ⭐ 2,822 | 🐛 12 | 🌐 JavaScript | 📅 2026-09-22 - Voice controlled smart mirror with IoT integration. ![Supports Raspberry Pi 2+](/media/badges/rpi-2+.png)
* [Circle](https://github.com/rsta2/circle) ⭐ 2,310 | 🐛 12 | 🌐 C | 📅 2026-09-22 - A C++ bare metal environment for Raspberry Pi.
* [Secluso](https://github.com/secluso/core) ⭐ 1,673 | 🐛 39 | 🌐 Rust | 📅 2026-09-22 - A private-by-default Raspberry Pi home security camera that uses end-to-end encryption. Supports Raspberry Pi Zero 2 W. ![Supports Raspberry Pi 2+](/media/badges/rpi-2+.png)
* [PiFmRds](https://github.com/ChristopheJacquet/PiFmRds) ⭐ 1,591 | 🐛 69 | 🌐 C | 📅 2026-02-01 - FM-RDS transmitter using a Raspberry Pi.
* [CookCLI](https://github.com/cooklang/CookCLI) ⭐ 1,389 | 🐛 35 | 🌐 Rust | 📅 2026-09-22 - Turn your Raspberry Pi into a self-hosted recipe server. Manage recipes in plain-text Cooklang format with web UI, shopping lists, and meal planning.
...
* [speed-camera](https://github.com/pageauc/speed-camera) ⭐ 1,106 | 🐛 20 | 🌐 Python | 📅 2026-09-23 - Object Motion Tracking uses python, openCV, USB Cam or picamera module to record speed data.
...
* [RustChain](https://github.com/Scottcjn/Rustchain) ⭐ 817 | 🐛 168 | 🌐 Python | 📅 2026-09-22 - Proof-of-Antiquity blockchain that rewards vintage and edge hardware including Raspberry Pi for mining. DePIN infrastructure for IoT devices.
...
* [Raspberry Pi Dashboard](https://github.com/femto-code/Raspberry-Pi-Dashboard) ⭐ 370 | 🐛 9 | 🌐 PHP | 📅 2024-06-26 - Full-featured web-based dashboard interface to inspect and manage Raspberry Pi hardware and software, with no extra software required.
...
* [ble-scale-sync](https://github.com/KristianP26/ble-scale-sync) ⭐ 175 | 🐛 19 | 🌐 TypeScript | 📅 2026-09-14 - Reads BLE smart scales (23 brands) via built-in Bluetooth, calculates body composition, and exports to Garmin Connect, MQTT/Home Assistant, InfluxDB, and more. [Website](https://blescalesync.dev).
* [Movel](https://github.com/stevelacy/movel) ⭐ 156 | 🐛 1 | 🌐 CoffeeScript | 📅 2015-12-21 - Raspberry Pi car computer.
* [BotWave](https://github.com/dpipstudio/botwave/) ⭐ 143 | 🐛 0 | 🌐 Python | 📅 2026-09-22 - FM broadcasting system with server-client architecture for managing multiple Raspberry Pi transmitters remotely. ![Supports Raspberry Pi Zero](/media/badges/rpi-0.png) ![Supports Raspberry Pi 2](/media/badges/rpi-2.png) ![Supports Raspberry Pi 3](/media/badges/rpi-3.png)
...
Contribution guidelines can be found [here](https://github.com/thibmaek/awesome-raspberry-pi/blob/main/CONTRIBUTING.md) ⭐ 16,910 | 🐛 28 | 🌐 Shell | 📅 2026-07-27
