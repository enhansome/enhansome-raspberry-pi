...
[![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 506,130 | 🐛 106 | 📅 2026-09-02
[![All Contributors](https://img.shields.io/badge/all_contributors-43-orange.svg)](https://github.com/thibmaek/awesome-raspberry-pi/blob/main/CONTRIBUTORS.md) ⭐ 16,879 | 🐛 26 | 🌐 Shell | 📅 2026-07-27
...
This list is a collection of tools, projects, images and resources conforming to the [Awesome Manifesto](https://github.com/sindresorhus/awesome/blob/main/awesome.md) ⭐ 506,130 | 🐛 106 | 📅 2026-09-02
...
* [motionEyeOS](https://github.com/ccrisan/motioneyeos/wiki) ⭐ 8,215 | 🐛 840 | 🌐 Makefile | 📅 2025-02-14 - Linux distribution that turns a single-board computer into a video surveillance system.
* [NextCloudPi](https://github.com/nextcloud/nextcloudpi) ⭐ 2,939 | 🐛 230 | 🌐 Shell | 📅 2026-09-07 - Nextcloud ready image based on Raspbian. Features Nextcloud 11 running on Raspbian 8, with PHP 7 and HTTP2 enabled Apache server.
* [chilipie-kiosk](https://github.com/futurice/chilipie-kiosk) ⭐ 1,397 | 🐛 69 | 🌐 HTML | 📅 2022-04-04 - Image which boots directly into full-screen Chrome, perfect for dashboards and build monitors. ![Supports Raspberry Pi 2+](/media/badges/rpi-2+.png)
* [DroneBridge](https://github.com/seeul8er/DroneBridge) ⭐ 951 | 🐛 16 | 🌐 C | 📅 2022-01-07 - A WifiBroadcast extension to make for a real alternative to DJI Lightbridge and other similar systems. ![Supports Raspberry Pi 3](/media/badges/rpi-3.png)
...
* [Mainsail OS](https://github.com/mainsail-crew/MainsailOS) ⭐ 746 | 🐛 4 | 🌐 Shell | 📅 2026-05-14 - A distribution for 3D Printers that includes everything to get started with Klipper Firmware and Mainsail.
* [PIrateRF](https://github.com/psyb0t/piraterf) ⭐ 279 | 🐛 0 | 🌐 Go | 📅 2026-08-01 - Turns a Raspberry Pi Zero W into a portable, browser-controlled RF transmitter with its own WiFi hotspot, supporting a dozen modes including FM broadcast, FT8, RTTY, POCSAG, and Morse. ![Supports Raspberry Pi Zero](/media/badges/rpi-0.png)
...
* [Pwnagotchi](https://github.com/evilsocket/pwnagotchi) ⭐ 9,202 | 🐛 293 | 🌐 Python | 📅 2026-08-19 - Pwnagotchi is an AI based Wi-Fi cracking tool that learns from its surrounding WiFi environment to maximize the crackable WPA key material it captures.
* [PiShrink](https://github.com/Drewsif/PiShrink/) ⭐ 4,109 | 🐛 21 | 🌐 Shell | 📅 2026-05-10 - Bash script that automatically shrinks a pi image that will then resize to the max size of the SD card on boot.
* [pi-gen](https://github.com/RPi-Distro/pi-gen) ⭐ 3,256 | 🐛 170 | 🌐 Shell | 📅 2026-09-14 - Tool used to create the raspberrypi.org Raspbian images. This can be used to create your own custom images with specific packages installed, etc.
* [Pi-Apps](https://github.com/Botspot/pi-apps) ⭐ 2,811 | 🐛 152 | 🌐 Shell | 📅 2026-09-15 - The most popular app store for Raspberry Pi computers, 100% open-source bash scripts.
...
* [sdm](https://github.com/gitbls/sdm) ⭐ 763 | 🐛 11 | 🌐 Shell | 📅 2026-08-05 - Easily and fully customize RasPiOS images. Install apps, configure settings, etc then burn SSDs/SD cards for lots of different systems from a single image, and each one boots up fully configured and ready for work. Or play.
...
* [Rpi MQTT Monitor](https://github.com/hjelev/rpi-mqtt-monitor) ⭐ 318 | 🐛 10 | 🌐 Python | 📅 2026-06-26 - The easiest way to track and control your Raspberry Pi or Ubuntu computer system health and performance in Home Assistant.
...
* [Pimod](https://github.com/Nature40/pimod) ⭐ 149 | 🐛 12 | 🌐 Shell | 📅 2026-06-18 - Reconfigure Raspberry Pi images with an easy, Docker-like configuration file.
...
* [ndm](https://github.com/gitbls/ndm) ⭐ 87 | 🐛 0 | 🌐 Python | 📅 2026-02-26 - Command line tool to easily manage DNS and DHCP servers.
* [pistrong](https://github.com/gitbls/pistrong) ⭐ 76 | 🐛 0 | 🌐 Shell | 📅 2025-01-19 - Manage certificate-secured strongSwan VPNs. Installer and command-line tool for client-server, site-to-site, and host-to-host VPNs.
...
* [RaspAP-webgui](https://github.com/billz/raspap-webgui) ⭐ 32 | 🐛 0 | 🌐 PHP | 📅 2025-12-26 - A simple, responsive web interface to control wifi, hostapd and related services on the Raspberry Pi.
...
* [AdGuard Home](https://github.com/AdguardTeam/AdGuardHome) ⭐ 36,899 | 🐛 1,245 | 🌐 TypeScript | 📅 2026-09-15 - DNS relay station with ad/tracker/other blocking, IP address redirections, and DNS-over-HTTPS.
* [Sonic Pi](https://github.com/samaaron/sonic-pi) ⭐ 12,137 | 🐛 28 | 🌐 C++ | 📅 2026-09-12 - The Live Coding Music Synth for Everyone.
* [Pi-KVM](https://github.com/pikvm/pikvm) ⭐ 10,339 | 🐛 89 | 📅 2026-09-10 - DIY KVM over IP to manage remote computers via Web UI or VNC with FullHD video, mouse, virtual drive, IPMI, Wake-on-LAN and many other things.
* [PoisonTap](https://github.com/samyk/poisontap) ⭐ 6,475 | 🐛 90 | 🌐 JavaScript | 📅 2018-11-26 - Exploits locked/password protected computers over USB, drops persistent WebSocket-based backdoor, exposes internal router, and siphons cookies using Raspberry Pi Zero & Node.js. ![Supports Raspberry Pi Zero](/media/badges/rpi-0.png)
* [P4wnP1](https://github.com/mame82/P4wnP1) ⭐ 4,381 | 🐛 118 | 🌐 Python | 📅 2024-08-12 - P4wnP1 is a highly customizable USB attack platform, based on a low cost Raspberry Pi Zero or Raspberry Pi Zero W (required for HID backdoor). ![Supports Raspberry Pi Zero](/media/badges/rpi-0.png)
* [Smart Mirror](https://github.com/evancohen/smart-mirror) ⭐ 2,821 | 🐛 20 | 🌐 JavaScript | 📅 2026-09-11 - Voice controlled smart mirror with IoT integration. ![Supports Raspberry Pi 2+](/media/badges/rpi-2+.png)
* [Circle](https://github.com/rsta2/circle) ⭐ 2,302 | 🐛 13 | 🌐 C | 📅 2026-09-14 - A C++ bare metal environment for Raspberry Pi.
* [Secluso](https://github.com/secluso/core) ⭐ 1,668 | 🐛 36 | 🌐 Rust | 📅 2026-08-24 - A private-by-default Raspberry Pi home security camera that uses end-to-end encryption. Supports Raspberry Pi Zero 2 W. ![Supports Raspberry Pi 2+](/media/badges/rpi-2+.png)
* [PiFmRds](https://github.com/ChristopheJacquet/PiFmRds) ⭐ 1,592 | 🐛 69 | 🌐 C | 📅 2026-02-01 - FM-RDS transmitter using a Raspberry Pi.
* [CookCLI](https://github.com/cooklang/CookCLI) ⭐ 1,384 | 🐛 34 | 🌐 Rust | 📅 2026-09-12 - Turn your Raspberry Pi into a self-hosted recipe server. Manage recipes in plain-text Cooklang format with web UI, shopping lists, and meal planning.
...
* [speed-camera](https://github.com/pageauc/speed-camera) ⭐ 1,104 | 🐛 20 | 🌐 Python | 📅 2025-10-17 - Object Motion Tracking uses python, openCV, USB Cam or picamera module to record speed data.
...
* [Haven](https://github.com/havenweb/haven) ⭐ 803 | 🐛 18 | 🌐 Ruby | 📅 2026-09-09 - Host a private blog on your Rasperry Pi instead of using Facebook.
* [RustChain](https://github.com/Scottcjn/Rustchain) ⭐ 795 | 🐛 137 | 🌐 Python | 📅 2026-09-15 - Proof-of-Antiquity blockchain that rewards vintage and edge hardware including Raspberry Pi for mining. DePIN infrastructure for IoT devices.
* [Sonus](https://github.com/evancohen/sonus) ⭐ 638 | 🐛 38 | 🌐 JavaScript | 📅 2026-09-11 - Node.js voice control for your Pi (and everything else) with customizable offline hotword detection.
...
* [DCS-BIOS](https://github.com/DCS-Skunkworks/dcs-bios) ⭐ 432 | 🐛 157 | 🌐 Lua | 📅 2026-09-15 - Exports DCS World cockpit data (switches, lights, displays) over serial/UDP to Arduino, ESP32, or Raspberry Pi for physical panel builds.
...
* [Raspberry Pi Dashboard](https://github.com/femto-code/Raspberry-Pi-Dashboard) ⭐ 369 | 🐛 9 | 🌐 PHP | 📅 2024-06-26 - Full-featured web-based dashboard interface to inspect and manage Raspberry Pi hardware and software, with no extra software required.
...
* [USB Proxy](https://github.com/AristoChen/usb-proxy) ⭐ 287 | 🐛 13 | 🌐 C++ | 📅 2026-04-11 - A USB man-in-the-middle project that allow users to monitor and modify USB packets flow between host and device.
* [SecPi](https://github.com/SecPi/SecPi) ⭐ 262 | 🐛 32 | 🌐 Python | 📅 2022-11-23 - Raspberry Pi based home alarm system.
* [Lomorage](https://github.com/lomorage/homepage) ⭐ 239 | 🐛 6 | 🌐 HTML | 📅 2026-08-20 - Private photo cloud host on Raspberry Pi, with Android/iOS/Web client.
...
* [Internet Chronometer](https://github.com/rothman857/chronometer) ⭐ 118 | 🐛 1 | 🌐 Python | 📅 2024-12-31 - Turn your Raspberry Pi in to an Internet Chronometer.
...
* [docsis-cable-load-monitor](https://github.com/sp4rkie/docsis-cable-load-monitor) ⭐ 69 | 🐛 0 | 🌐 Shell | 📅 2022-08-05 - Tool to monitor downstream load on DOCSIS cable networks.
...
* [Raspberry Pi Setup](https://github.com/atao/raspberrypi-setup) ⭐ 53 | 🐛 0 | 🌐 Shell | 📅 2026-09-07 - ⚡ Quickly setup my Raspberry Pi.
...
* [HookProbe](https://github.com/hookprobe/hookprobe) ⭐ 45 | 🐛 0 | 🌐 Python | 📅 2026-08-19 - AI-native intrusion detection system with eBPF/XDP packet filtering and ML threat classification. Processes 8.8M+ security events on a Pi 5.
...
* [Raspberry Pi Telegram Bot](https://github.com/GraveEaterMadison/Raspberry_pi_telegram_bot) ⭐ 35 | 🐛 0 | 🌐 Python | 📅 2026-05-16 - Remotely control your Raspberry Pi using Telegram, with support for GPIO, system commands, custom modules, and real-time interaction.
...
* [DIY Arcade Machine](https://github.com/SimonWaldherr/DIY-Arcade-Machine) ⭐ 26 | 🐛 0 | 🌐 Python | 📅 2026-09-14 - A retro style arcade machine, based on a Raspberry Pi Pico, a Hub75 LED matrix and some other stuff (Wii Nunchucks, 3D printed parts, ...)
...
* [RaspiBlitz](https://github.com/rootzoll/raspiblitz) ⭐ 20 | 🐛 1 | 📅 2025-12-23 - Fastest and cheapest way to get your own Lightning Node running.
* [Gaussmeter](https://github.com/gaussmeter/gaussmeter) ⭐ 16 | 🐛 0 | 🌐 Shell | 📅 2023-11-13 - Project utilizing a Raspberry Pi Zero W, WS2812B Leds and the Tesla API to collect and display a Tesla's status. ![Supports Raspberry Pi Zero](/media/badges/rpi-0.png)
...
* [NanoBot AI Chat Robot](https://github.com/samartzidis/NanoBot) ⭐ 4 | 🐛 0 | 🌐 C# | 📅 2026-09-12 - Raspberry Pi powered AI chat robot, ideal for education and teaching assistance.
...
* [Moonlight](https://github.com/irtimmer/moonlight-embedded) ⭐ 1,659 | 🐛 121 | 🌐 C | 📅 2026-06-06 - Nvidia GameStream implementation to stream your full collection of Steam games from desktop to the Raspberry Pi.
...
* [SwiftyGPIO](https://github.com/uraimo/SwiftyGPIO) ⭐ 1,367 | 🐛 36 | 🌐 Swift | 📅 2024-05-02 - Swift library for hardware projects on Linux/ARM boards with support for GPIOs/SPI/I2C/PWM/UART/1Wire.
...
Contribution guidelines can be found [here](https://github.com/thibmaek/awesome-raspberry-pi/blob/main/CONTRIBUTING.md) ⭐ 16,879 | 🐛 26 | 🌐 Shell | 📅 2026-07-27
