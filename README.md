...
[![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 510,565 | 🐛 107 | 📅 2026-09-02
[![All Contributors](https://img.shields.io/badge/all_contributors-43-orange.svg)](https://github.com/thibmaek/awesome-raspberry-pi/blob/main/CONTRIBUTORS.md) ⭐ 16,923 | 🐛 31 | 🌐 Shell | 📅 2026-07-27
...
This list is a collection of tools, projects, images and resources conforming to the [Awesome Manifesto](https://github.com/sindresorhus/awesome/blob/main/awesome.md) ⭐ 510,565 | 🐛 107 | 📅 2026-09-02
...
* [Pwnagotchi](https://github.com/evilsocket/pwnagotchi) ⭐ 9,210 | 🐛 293 | 🌐 Python | 📅 2026-08-19 - Pwnagotchi is an AI based Wi-Fi cracking tool that learns from its surrounding WiFi environment to maximize the crackable WPA key material it captures.
...
* [pi-gen](https://github.com/RPi-Distro/pi-gen) ⭐ 3,262 | 🐛 166 | 🌐 Shell | 📅 2026-09-16 - Tool used to create the raspberrypi.org Raspbian images. This can be used to create your own custom images with specific packages installed, etc.
* [Pi-Apps](https://github.com/Botspot/pi-apps) ⭐ 2,816 | 🐛 152 | 🌐 Shell | 📅 2026-09-25 - The most popular app store for Raspberry Pi computers, 100% open-source bash scripts.
* [PiKISS](https://github.com/jmcerrejon/PiKISS) ⭐ 1,010 | 🐛 22 | 🌐 Shell | 📅 2026-07-27 - A bunch of scripts with menu to make your life easier.
...
* [Rpi MQTT Monitor](https://github.com/hjelev/rpi-mqtt-monitor) ⭐ 319 | 🐛 10 | 🌐 Python | 📅 2026-06-26 - The easiest way to track and control your Raspberry Pi or Ubuntu computer system health and performance in Home Assistant.
...
* [AdGuard Home](https://github.com/AdguardTeam/AdGuardHome) ⭐ 37,070 | 🐛 1,259 | 🌐 TypeScript | 📅 2026-09-25 - DNS relay station with ad/tracker/other blocking, IP address redirections, and DNS-over-HTTPS.
* [Sonic Pi](https://github.com/samaaron/sonic-pi) ⭐ 12,156 | 🐛 34 | 🌐 C++ | 📅 2026-09-24 - The Live Coding Music Synth for Everyone.
* [Pi-KVM](https://github.com/pikvm/pikvm) ⭐ 10,363 | 🐛 89 | 📅 2026-09-21 - DIY KVM over IP to manage remote computers via Web UI or VNC with FullHD video, mouse, virtual drive, IPMI, Wake-on-LAN and many other things.
...
* [Smart Mirror](https://github.com/evancohen/smart-mirror) ⭐ 2,822 | 🐛 14 | 🌐 JavaScript | 📅 2026-09-25 - Voice controlled smart mirror with IoT integration. ![Supports Raspberry Pi 2+](/media/badges/rpi-2+.png)
* [Circle](https://github.com/rsta2/circle) ⭐ 2,311 | 🐛 13 | 🌐 C | 📅 2026-09-25 - A C++ bare metal environment for Raspberry Pi.
...
* [CookCLI](https://github.com/cooklang/CookCLI) ⭐ 1,391 | 🐛 36 | 🌐 Rust | 📅 2026-09-25 - Turn your Raspberry Pi into a self-hosted recipe server. Manage recipes in plain-text Cooklang format with web UI, shopping lists, and meal planning.
...
* [RustChain](https://github.com/Scottcjn/Rustchain) ⭐ 829 | 🐛 166 | 🌐 Python | 📅 2026-09-26 - Proof-of-Antiquity blockchain that rewards vintage and edge hardware including Raspberry Pi for mining. DePIN infrastructure for IoT devices.
...
* [DCS-BIOS](https://github.com/DCS-Skunkworks/dcs-bios) ⭐ 433 | 🐛 172 | 🌐 Lua | 📅 2026-09-26 - Exports DCS World cockpit data (switches, lights, displays) over serial/UDP to Arduino, ESP32, or Raspberry Pi for physical panel builds.
...
* [Lomorage](https://github.com/lomorage/homepage) ⭐ 239 | 🐛 8 | 🌐 HTML | 📅 2026-09-25 - Private photo cloud host on Raspberry Pi, with Android/iOS/Web client.
...
* [ble-scale-sync](https://github.com/KristianP26/ble-scale-sync) ⭐ 177 | 🐛 20 | 🌐 TypeScript | 📅 2026-09-14 - Reads BLE smart scales (23 brands) via built-in Bluetooth, calculates body composition, and exports to Garmin Connect, MQTT/Home Assistant, InfluxDB, and more. [Website](https://blescalesync.dev).
...
* [Moonlight](https://github.com/irtimmer/moonlight-embedded) ⭐ 1,662 | 🐛 121 | 🌐 C | 📅 2026-06-06 - Nvidia GameStream implementation to stream your full collection of Steam games from desktop to the Raspberry Pi.
...
Contribution guidelines can be found [here](https://github.com/thibmaek/awesome-raspberry-pi/blob/main/CONTRIBUTING.md) ⭐ 16,923 | 🐛 31 | 🌐 Shell | 📅 2026-07-27
