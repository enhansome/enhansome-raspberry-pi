...
[![All Contributors](https://img.shields.io/badge/all_contributors-43-orange.svg)](https://github.com/thibmaek/awesome-raspberry-pi/blob/main/CONTRIBUTORS.md) ⭐ 16,720 | 🐛 17 | 🌐 Shell | 📅 2026-07-27
...
This list is a collection of tools, projects, images and resources conforming to the [Awesome Manifesto](https://github.com/sindresorhus/awesome/blob/main/awesome.md) ⭐ 495,058 | 🐛 100 | 📅 2026-06-30
...
* [motionEyeOS](https://github.com/ccrisan/motioneyeos/wiki) ⭐ 8,208 | 🐛 839 | 🌐 Makefile | 📅 2025-02-14 - Linux distribution that turns a single-board computer into a video surveillance system.
* [NextCloudPi](https://github.com/nextcloud/nextcloudpi) ⭐ 2,931 | 🐛 222 | 🌐 Shell | 📅 2026-07-27 - Nextcloud ready image based on Raspbian. Features Nextcloud 11 running on Raspbian 8, with PHP 7 and HTTP2 enabled Apache server.
...
* [DroneBridge](https://github.com/seeul8er/DroneBridge) ⭐ 942 | 🐛 16 | 🌐 C | 📅 2022-01-07 - A WifiBroadcast extension to make for a real alternative to DJI Lightbridge and other similar systems. ![Supports Raspberry Pi 3](/media/badges/rpi-3.png)
* [EZ-WifiBroadcast](https://github.com/bortek/EZ-WifiBroadcast/wiki) ⭐ 897 | 🐛 62 | 🌐 C | 📅 2024-01-31 - Affordable Wireless Digital HD Video Transmission made easy. ![Supports Raspberry Pi 3](/media/badges/rpi-3.png) ![Supports Raspberry Pi Zero](/media/badges/rpi-0.png)
* [Mainsail OS](https://github.com/mainsail-crew/MainsailOS) ⭐ 744 | 🐛 3 | 🌐 Shell | 📅 2026-05-14 - A distribution for 3D Printers that includes everything to get started with Klipper Firmware and Mainsail.
* [PIrateRF](https://github.com/psyb0t/piraterf) ⭐ 276 | 🐛 0 | 🌐 Go | 📅 2026-08-01 - Turns a Raspberry Pi Zero W into a portable, browser-controlled RF transmitter with its own WiFi hotspot, supporting a dozen modes including FM broadcast, FT8, RTTY, POCSAG, and Morse. ![Supports Raspberry Pi Zero](/media/badges/rpi-0.png)
* [DietPi](https://github.com/Fourdee/DietPi) ⭐ 18 | 🐛 0 | 📅 2023-04-20 - Minimal image designed to fit on a 2GB SD card, with tons of configurable settings and scripts.
* [RasComm RaspberryPi MorseCode Translator](https://github.com/Defcon27/RasComm-RaspberryPi-MorseCode-Translator) ⭐ 16 | 🐛 0 | 🌐 Python | 📅 2020-07-25 - RasComm is a communication device that translates plain text into Morse code (IMC) visually or audibly.
* [GlowBarn OS](https://github.com/bad-antics/glowbarn-os) ⭐ 2 | 🐛 0 | 🌐 Rust | 📅 2026-02-11 - Buildroot-based Linux distribution for paranormal research with EMF sensors, environmental monitoring, web dashboard and automated data logging. ![Supports Raspberry Pi 4+](/media/badges/rpi-4.png)
...
* [Pwnagotchi](https://github.com/evilsocket/pwnagotchi) ⭐ 9,167 | 🐛 294 | 🌐 Python | 📅 2025-08-23 - Pwnagotchi is an AI based Wi-Fi cracking tool that learns from its surrounding WiFi environment to maximize the crackable WPA key material it captures.
* [PiShrink](https://github.com/Drewsif/PiShrink/) ⭐ 4,091 | 🐛 21 | 🌐 Shell | 📅 2026-05-10 - Bash script that automatically shrinks a pi image that will then resize to the max size of the SD card on boot.
* [pi-gen](https://github.com/RPi-Distro/pi-gen) ⭐ 3,226 | 🐛 167 | 🌐 Shell | 📅 2026-06-19 - Tool used to create the raspberrypi.org Raspbian images. This can be used to create your own custom images with specific packages installed, etc.
* [Pi-Apps](https://github.com/Botspot/pi-apps) ⭐ 2,791 | 🐛 150 | 🌐 Shell | 📅 2026-08-13 - The most popular app store for Raspberry Pi computers, 100% open-source bash scripts.
* [PiKISS](https://github.com/jmcerrejon/PiKISS) ⭐ 1,007 | 🐛 22 | 🌐 Shell | 📅 2026-07-27 - A bunch of scripts with menu to make your life easier.
* [sdm](https://github.com/gitbls/sdm) ⭐ 758 | 🐛 11 | 🌐 Shell | 📅 2026-08-05 - Easily and fully customize RasPiOS images. Install apps, configure settings, etc then burn SSDs/SD cards for lots of different systems from a single image, and each one boots up fully configured and ready for work. Or play.
* [stressberry](https://github.com/nschloe/stressberry) ⭐ 365 | 🐛 40 | 🌐 Python | 📅 2023-06-17 - Stress test your Raspberry Pi and plot temperatures.
* [Rpi MQTT Monitor](https://github.com/hjelev/rpi-mqtt-monitor) ⭐ 316 | 🐛 7 | 🌐 Python | 📅 2026-06-26 - The easiest way to track and control your Raspberry Pi or Ubuntu computer system health and performance in Home Assistant.
...
* [Pimod](https://github.com/Nature40/pimod) ⭐ 149 | 🐛 9 | 🌐 Shell | 📅 2026-06-18 - Reconfigure Raspberry Pi images with an easy, Docker-like configuration file.
* [TorTiPi](https://github.com/r0hi7/tortipi) ⭐ 128 | 🐛 0 | 🌐 Shell | 📅 2020-11-29 - Shell script to automate the task of converting Raspberry Pi into a tor based wifi hotspot.
...
* [ndm](https://github.com/gitbls/ndm) ⭐ 86 | 🐛 0 | 🌐 Python | 📅 2026-02-26 - Command line tool to easily manage DNS and DHCP servers.
* [pistrong](https://github.com/gitbls/pistrong) ⭐ 75 | 🐛 0 | 🌐 Shell | 📅 2025-01-19 - Manage certificate-secured strongSwan VPNs. Installer and command-line tool for client-server, site-to-site, and host-to-host VPNs.
* [Alpha](https://github.com/farjump/raspberry-pi) ⭐ 49 | 🐛 3 | 🌐 C | 📅 2018-09-29 - Remotely load, debug and test bare-metal programs using GDB with this system-level GDB server.
* [PiGro](https://github.com/actionschnitzel/PiGro-Aid-) ⭐ 48 | 🐛 1 | 🌐 Python | 📅 2026-04-14 - PiGro does many commands that have to be entered via the terminal with one or two clicks of a button.
* [RPi Monitor Dashboard](https://github.com/nekromoff/rpi-monitor-dashboard) ⭐ 45 | 🐛 0 | 🌐 PHP | 📅 2025-05-28 - Simple monitoring tool with a dashboard suitable for monitoring multiple RPi devices (CPU temperature, network, ping, browser, screenshot of X display etc.).
...
* [Pi Temperature Exporter](https://github.com/s-nagaev/pi-temperature-exporter) ⭐ 32 | 🐛 0 | 🌐 Rust | 📅 2023-08-09 - a CPU and GPU temperature exporter for Prometheus consumption.
* [RaspAP-webgui](https://github.com/billz/raspap-webgui) ⭐ 30 | 🐛 0 | 🌐 PHP | 📅 2025-12-26 - A simple, responsive web interface to control wifi, hostapd and related services on the Raspberry Pi.
* [Hardened Kernel Builder for RPi](https://github.com/tschaffter/raspberry-pi-kernel-hardened) ⭐ 24 | 🐛 1 | 🌐 Shell | 📅 2022-10-01 - Cross-compile the Linux kernel for Raspberry Pi with enhanced security using a single command.
* [rpi-cookstrap](https://github.com/heeplr/rpi-cookstrap) ⭐ 18 | 🐛 2 | 🌐 Shell | 📅 2025-09-26 - A lightweight, plugin based bakery shell script framework to customize, bootstrap & provision raspberry pi OS disk images.
* [n01d-forge](https://github.com/bad-antics/n01d-forge) ⭐ 13 | 🐛 0 | 🌐 Rust | 📅 2026-02-11 - Native Rust image burner with LUKS/VeraCrypt encryption support, perfect for creating secure bootable SD cards for Raspberry Pi.
* [PiPulse](https://github.com/techtiki21/PiPulse) ⭐ 2 | 🐛 0 | 🌐 Python | 📅 2026-06-19 - Monitor Raspberry Pi at all times without SSH.
...
* [AdGuard Home](https://github.com/AdguardTeam/AdGuardHome) ⭐ 36,085 | 🐛 1,271 | 🌐 TypeScript | 📅 2026-08-12 - DNS relay station with ad/tracker/other blocking, IP address redirections, and DNS-over-HTTPS.
* [Sonic Pi](https://github.com/samaaron/sonic-pi) ⭐ 12,059 | 🐛 22 | 🌐 C++ | 📅 2026-08-12 - The Live Coding Music Synth for Everyone.
* [Pi-KVM](https://github.com/pikvm/pikvm) ⭐ 10,248 | 🐛 89 | 📅 2026-08-09 - DIY KVM over IP to manage remote computers via Web UI or VNC with FullHD video, mouse, virtual drive, IPMI, Wake-on-LAN and many other things.
* [PoisonTap](https://github.com/samyk/poisontap) ⭐ 6,474 | 🐛 90 | 🌐 JavaScript | 📅 2018-11-26 - Exploits locked/password protected computers over USB, drops persistent WebSocket-based backdoor, exposes internal router, and siphons cookies using Raspberry Pi Zero & Node.js. ![Supports Raspberry Pi Zero](/media/badges/rpi-0.png)
* [P4wnP1](https://github.com/mame82/P4wnP1) ⭐ 4,380 | 🐛 119 | 🌐 Python | 📅 2024-08-12 - P4wnP1 is a highly customizable USB attack platform, based on a low cost Raspberry Pi Zero or Raspberry Pi Zero W (required for HID backdoor). ![Supports Raspberry Pi Zero](/media/badges/rpi-0.png)
* [Smart Mirror](https://github.com/evancohen/smart-mirror) ⭐ 2,818 | 🐛 19 | 🌐 JavaScript | 📅 2024-07-02 - Voice controlled smart mirror with IoT integration. ![Supports Raspberry Pi 2+](/media/badges/rpi-2+.png)
* [Circle](https://github.com/rsta2/circle) ⭐ 2,291 | 🐛 14 | 🌐 C | 📅 2026-08-09 - A C++ bare metal environment for Raspberry Pi.
* [Secluso](https://github.com/secluso/core) ⭐ 1,654 | 🐛 35 | 🌐 Rust | 📅 2026-08-10 - A private-by-default Raspberry Pi home security camera that uses end-to-end encryption. Supports Raspberry Pi Zero 2 W. ![Supports Raspberry Pi 2+](/media/badges/rpi-2+.png)
* [PiFmRds](https://github.com/ChristopheJacquet/PiFmRds) ⭐ 1,582 | 🐛 69 | 🌐 C | 📅 2026-02-01 - FM-RDS transmitter using a Raspberry Pi.
* [CookCLI](https://github.com/cooklang/CookCLI) ⭐ 1,364 | 🐛 30 | 🌐 Rust | 📅 2026-08-12 - Turn your Raspberry Pi into a self-hosted recipe server. Manage recipes in plain-text Cooklang format with web UI, shopping lists, and meal planning.
* [Stratux](https://github.com/cyoung/stratux) ⭐ 1,129 | 🐛 121 | 🌐 C | 📅 2026-02-18 - Open source ADS-B receiver which feeds weather, traffic, GPS, and AHRS data to electronic flight bag software via wifi.
* [speed-camera](https://github.com/pageauc/speed-camera) ⭐ 1,102 | 🐛 20 | 🌐 Python | 📅 2025-10-17 - Object Motion Tracking uses python, openCV, USB Cam or picamera module to record speed data.
...
* [Haven](https://github.com/havenweb/haven) ⭐ 800 | 🐛 17 | 🌐 Ruby | 📅 2026-08-11 - Host a private blog on your Rasperry Pi instead of using Facebook.
...
* [PiClock](https://github.com/n0bel/PiClock) ⭐ 589 | 🐛 39 | 🌐 Python | 📅 2024-07-15 - Fancy Clock built around a monitor and a Raspberry Pi.
* [pi-timolo](https://github.com/pageauc/pi-timolo) ⭐ 580 | 🐛 2 | 🌐 Python | 📅 2025-05-07 - Remote Headless multi feature PiCamera Operation from Rclone Remote Storage Service and More.
* [RustChain](https://github.com/Scottcjn/Rustchain) ⭐ 576 | 🐛 170 | 🌐 Python | 📅 2026-08-12 - Proof-of-Antiquity blockchain that rewards vintage and edge hardware including Raspberry Pi for mining. DePIN infrastructure for IoT devices.
* [DCS-BIOS](https://github.com/DCS-Skunkworks/dcs-bios) ⭐ 426 | 🐛 71 | 🌐 Lua | 📅 2026-08-12 - Exports DCS World cockpit data (switches, lights, displays) over serial/UDP to Arduino, ESP32, or Raspberry Pi for physical panel builds.
...
* [USB Proxy](https://github.com/AristoChen/usb-proxy) ⭐ 282 | 🐛 13 | 🌐 C++ | 📅 2026-04-11 - A USB man-in-the-middle project that allow users to monitor and modify USB packets flow between host and device.
* [SecPi](https://github.com/SecPi/SecPi) ⭐ 263 | 🐛 32 | 🌐 Python | 📅 2022-11-23 - Raspberry Pi based home alarm system.
* [Lomorage](https://github.com/lomorage/homepage) ⭐ 238 | 🐛 6 | 🌐 HTML | 📅 2026-08-09 - Private photo cloud host on Raspberry Pi, with Android/iOS/Web client.
* [CocktailMaker](https://github.com/alex9849/pi-cocktail-maker) ⭐ 192 | 🐛 16 | 🌐 Java | 📅 2026-05-06 - An advanced cocktail making machine that can be controlled via browser and touchscreen.
* [Movel](https://github.com/stevelacy/movel) ⭐ 156 | 🐛 1 | 🌐 CoffeeScript | 📅 2015-12-21 - Raspberry Pi car computer.
* [ble-scale-sync](https://github.com/KristianP26/ble-scale-sync) ⭐ 148 | 🐛 21 | 🌐 TypeScript | 📅 2026-08-02 - Reads BLE smart scales (23 brands) via built-in Bluetooth, calculates body composition, and exports to Garmin Connect, MQTT/Home Assistant, InfluxDB, and more. [Website](https://blescalesync.dev).
* [BotWave](https://github.com/dpipstudio/botwave/) ⭐ 140 | 🐛 0 | 🌐 Python | 📅 2026-08-12 - FM broadcasting system with server-client architecture for managing multiple Raspberry Pi transmitters remotely. ![Supports Raspberry Pi Zero](/media/badges/rpi-0.png) ![Supports Raspberry Pi 2](/media/badges/rpi-2.png) ![Supports Raspberry Pi 3](/media/badges/rpi-3.png)
...
* [docsis-cable-load-monitor](https://github.com/sp4rkie/docsis-cable-load-monitor) ⭐ 68 | 🐛 0 | 🌐 Shell | 📅 2022-08-05 - Tool to monitor downstream load on DOCSIS cable networks.
* [clockOS](https://github.com/iGerli/clockOS) ⭐ 57 | 🐛 9 | 🌐 JavaScript | 📅 2017-06-21 - simple smart desktop clock using a Raspberry Pi display.
* [Raspberry Pi Setup](https://github.com/atao/raspberrypi-setup) ⭐ 53 | 🐛 0 | 🌐 Shell | 📅 2026-06-03 - ⚡ Quickly setup my Raspberry Pi.
...
* [FistBump BLE Edition](https://github.com/eliddell1/Project-Blue-Fist/blob/master/README.md) ⭐ 50 | 🐛 0 | 🌐 Java | 📅 2018-11-24 - WPA Hash Grabbing Bluetooth Peripheral / Android App.
...
* [Display\_Lib\_RPI](https://github.com/gavinlyonsrepo/Display_Lib_RPI) ⭐ 44 | 🐛 0 | 🌐 C++ | 📅 2026-07-08 - A shared installable C++ Library to connect various electronic displays to Raspberry Pi single board computers.
* [HookProbe](https://github.com/hookprobe/hookprobe) ⭐ 43 | 🐛 1 | 🌐 Python | 📅 2026-07-27 - AI-native intrusion detection system with eBPF/XDP packet filtering and ML threat classification. Processes 8.8M+ security events on a Pi 5.
...
* [Cama-Camel Pack](https://github.com/Barqawiz/iot_watering_system) ⭐ 32 | 🐛 0 | 🌐 Python | 📅 2025-01-02 - A home-based irrigation system for efficient plant care using IoT.
* [pi\_payments](https://github.com/anshulahuja98/pi_payments) ⭐ 29 | 🐛 0 | 🌐 Python | 📅 2018-05-13 - Payment module based on RFID.
* [DIY Arcade Machine](https://github.com/SimonWaldherr/DIY-Arcade-Machine) ⭐ 24 | 🐛 0 | 🌐 Python | 📅 2026-07-11 - A retro style arcade machine, based on a Raspberry Pi Pico, a Hub75 LED matrix and some other stuff (Wii Nunchucks, 3D printed parts, ...)
* [idle-less](https://github.com/tvup/idle-less) ⭐ 22 | 🐛 0 | 🌐 Shell | 📅 2026-03-12 - Docker-based nginx reverse proxy that wakes sleeping servers via Wake-on-LAN, ideal for energy-saving Raspberry Pi homelabs.
...
* [Drumbooth controller with touch interface](https://github.com/FDelporte/DrumBoothController) ⭐ 13 | 🐛 0 | 🌐 Java | 📅 2026-01-22 - Project using Java, JavaFX, Pi4J and Arduino to control 8 relays and LED strips.
...
* [RGB-LED-Matrix](https://github.com/SimonWaldherr/RGB-LED-Matrix) ⭐ 10 | 🐛 0 | 🌐 Go | 📅 2024-10-02 - A 128x128 Pixel RGB LED Matrix to display images, animations, conways game of life and other stuff.
...
* [Ultimate DNS Shield](https://github.com/cherifon/Ultimate-DNS-Shield) ⭐ 7 | 🐛 0 | 🌐 Shell | 📅 2026-04-02 - Self-hosted recursive DNS server using Pi-hole, Unbound and Docker on Raspberry Pi 4.
* [NanoBot AI Chat Robot](https://github.com/samartzidis/NanoBot) ⭐ 4 | 🐛 0 | 🌐 C# | 📅 2026-05-10 - Raspberry Pi powered AI chat robot, ideal for education and teaching assistance.
...
* [PiSpot-Show](https://github.com/GeiserX/PiSpot-Show) ⚠️ Archived - WiFi voucher display system with weather integration and PiJuice battery management. ![Supports Raspberry Pi 3](/media/badges/rpi-3.png)
* [PiSpot Watch](https://github.com/GeiserX/PiSpot-Watch) ⚠️ Archived - Wrist-wearable Pi Zero smartwatch with e-ink display that generates Wi-Fi voucher codes on demand via button press. ![Supports Raspberry Pi Zero](/media/badges/rpi-0.png)
...
* [Raspberry Pi A to Z List](https://github.com/wtsxDev/Raspberry-Pi) ⭐ 961 | 🐛 0 | 📅 2021-05-15 - Comprehensive list with links to common questions & pitfalls.
...
* [Moonlight](https://github.com/irtimmer/moonlight-embedded) ⭐ 1,649 | 🐛 120 | 🌐 C | 📅 2026-06-06 - Nvidia GameStream implementation to stream your full collection of Steam games from desktop to the Raspberry Pi.
...
* [SwiftyGPIO](https://github.com/uraimo/SwiftyGPIO) ⭐ 1,370 | 🐛 36 | 🌐 Swift | 📅 2024-05-02 - Swift library for hardware projects on Linux/ARM boards with support for GPIOs/SPI/I2C/PWM/UART/1Wire.
...
* [Swish](https://github.com/thomaspaulmann/Swish) ⭐ 274 | 🐛 5 | 🌐 Shell | 📅 2017-01-08 - Build Swift Projects on a remote machine within Xcode.
...
Contribution guidelines can be found [here](https://github.com/thibmaek/awesome-raspberry-pi/blob/main/CONTRIBUTING.md) ⭐ 16,720 | 🐛 17 | 🌐 Shell | 📅 2026-07-27
