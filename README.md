...
[![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 510,076 | 🐛 107 | 📅 2026-09-02
[![All Contributors](https://img.shields.io/badge/all_contributors-43-orange.svg)](https://github.com/thibmaek/awesome-raspberry-pi/blob/main/CONTRIBUTORS.md) ⭐ 16,919 | 🐛 30 | 🌐 Shell | 📅 2026-07-27
...
This list is a collection of tools, projects, images and resources conforming to the [Awesome Manifesto](https://github.com/sindresorhus/awesome/blob/main/awesome.md) ⭐ 510,076 | 🐛 107 | 📅 2026-09-02
...
* [Pwnagotchi](https://github.com/evilsocket/pwnagotchi) ⭐ 9,209 | 🐛 293 | 🌐 Python | 📅 2026-08-19 - Pwnagotchi is an AI based Wi-Fi cracking tool that learns from its surrounding WiFi environment to maximize the crackable WPA key material it captures.
...
* [Pi-Apps](https://github.com/Botspot/pi-apps) ⭐ 2,815 | 🐛 151 | 🌐 Shell | 📅 2026-09-25 - The most popular app store for Raspberry Pi computers, 100% open-source bash scripts.
...
* [AdGuard Home](https://github.com/AdguardTeam/AdGuardHome) ⭐ 37,058 | 🐛 1,259 | 🌐 TypeScript | 📅 2026-09-24 - DNS relay station with ad/tracker/other blocking, IP address redirections, and DNS-over-HTTPS.
* [Sonic Pi](https://github.com/samaaron/sonic-pi) ⭐ 12,153 | 🐛 33 | 🌐 C++ | 📅 2026-09-24 - The Live Coding Music Synth for Everyone.
* [Pi-KVM](https://github.com/pikvm/pikvm) ⭐ 10,359 | 🐛 89 | 📅 2026-09-21 - DIY KVM over IP to manage remote computers via Web UI or VNC with FullHD video, mouse, virtual drive, IPMI, Wake-on-LAN and many other things.
...
* [Smart Mirror](https://github.com/evancohen/smart-mirror) ⭐ 2,822 | 🐛 13 | 🌐 JavaScript | 📅 2026-09-24 - Voice controlled smart mirror with IoT integration. ![Supports Raspberry Pi 2+](/media/badges/rpi-2+.png)
* [Circle](https://github.com/rsta2/circle) ⭐ 2,311 | 🐛 12 | 🌐 C | 📅 2026-09-24 - A C++ bare metal environment for Raspberry Pi.
* [Secluso](https://github.com/secluso/core) ⭐ 1,675 | 🐛 41 | 🌐 Rust | 📅 2026-09-24 - A private-by-default Raspberry Pi home security camera that uses end-to-end encryption. Supports Raspberry Pi Zero 2 W. ![Supports Raspberry Pi 2+](/media/badges/rpi-2+.png)
* [PiFmRds](https://github.com/ChristopheJacquet/PiFmRds) ⭐ 1,593 | 🐛 69 | 🌐 C | 📅 2026-02-01 - FM-RDS transmitter using a Raspberry Pi.
* [CookCLI](https://github.com/cooklang/CookCLI) ⭐ 1,391 | 🐛 35 | 🌐 Rust | 📅 2026-09-24 - Turn your Raspberry Pi into a self-hosted recipe server. Manage recipes in plain-text Cooklang format with web UI, shopping lists, and meal planning.
* [Stratux](https://github.com/cyoung/stratux) ⭐ 1,136 | 🐛 121 | 🌐 C | 📅 2026-02-18 - Open source ADS-B receiver which feeds weather, traffic, GPS, and AHRS data to electronic flight bag software via wifi.
...
* [RustChain](https://github.com/Scottcjn/Rustchain) ⭐ 826 | 🐛 175 | 🌐 Python | 📅 2026-09-25 - Proof-of-Antiquity blockchain that rewards vintage and edge hardware including Raspberry Pi for mining. DePIN infrastructure for IoT devices.
...
* [DCS-BIOS](https://github.com/DCS-Skunkworks/dcs-bios) ⭐ 433 | 🐛 172 | 🌐 Lua | 📅 2026-09-25 - Exports DCS World cockpit data (switches, lights, displays) over serial/UDP to Arduino, ESP32, or Raspberry Pi for physical panel builds.
...
* [ble-scale-sync](https://github.com/KristianP26/ble-scale-sync) ⭐ 176 | 🐛 20 | 🌐 TypeScript | 📅 2026-09-14 - Reads BLE smart scales (23 brands) via built-in Bluetooth, calculates body composition, and exports to Garmin Connect, MQTT/Home Assistant, InfluxDB, and more. [Website](https://blescalesync.dev).
...
Contribution guidelines can be found [here](https://github.com/thibmaek/awesome-raspberry-pi/blob/main/CONTRIBUTING.md) ⭐ 16,919 | 🐛 30 | 🌐 Shell | 📅 2026-07-27
