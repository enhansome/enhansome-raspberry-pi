...
[![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 507,238 | 🐛 106 | 📅 2026-09-02
[![All Contributors](https://img.shields.io/badge/all_contributors-43-orange.svg)](https://github.com/thibmaek/awesome-raspberry-pi/blob/main/CONTRIBUTORS.md) ⭐ 16,885 | 🐛 28 | 🌐 Shell | 📅 2026-07-27
...
This list is a collection of tools, projects, images and resources conforming to the [Awesome Manifesto](https://github.com/sindresorhus/awesome/blob/main/awesome.md) ⭐ 507,238 | 🐛 106 | 📅 2026-09-02
...
* [motionEyeOS](https://github.com/ccrisan/motioneyeos/wiki) ⭐ 8,213 | 🐛 840 | 🌐 Makefile | 📅 2025-02-14 - Linux distribution that turns a single-board computer into a video surveillance system.
...
* [Pwnagotchi](https://github.com/evilsocket/pwnagotchi) ⭐ 9,204 | 🐛 293 | 🌐 Python | 📅 2026-08-19 - Pwnagotchi is an AI based Wi-Fi cracking tool that learns from its surrounding WiFi environment to maximize the crackable WPA key material it captures.
...
* [pi-gen](https://github.com/RPi-Distro/pi-gen) ⭐ 3,259 | 🐛 166 | 🌐 Shell | 📅 2026-09-16 - Tool used to create the raspberrypi.org Raspbian images. This can be used to create your own custom images with specific packages installed, etc.
* [Pi-Apps](https://github.com/Botspot/pi-apps) ⭐ 2,813 | 🐛 156 | 🌐 Shell | 📅 2026-09-17 - The most popular app store for Raspberry Pi computers, 100% open-source bash scripts.
...
* [Pimod](https://github.com/Nature40/pimod) ⭐ 149 | 🐛 5 | 🌐 Shell | 📅 2026-09-17 - Reconfigure Raspberry Pi images with an easy, Docker-like configuration file.
...
* [AdGuard Home](https://github.com/AdguardTeam/AdGuardHome) ⭐ 36,964 | 🐛 1,254 | 🌐 TypeScript | 📅 2026-09-17 - DNS relay station with ad/tracker/other blocking, IP address redirections, and DNS-over-HTTPS.
* [Sonic Pi](https://github.com/samaaron/sonic-pi) ⭐ 12,141 | 🐛 28 | 🌐 C++ | 📅 2026-09-12 - The Live Coding Music Synth for Everyone.
* [Pi-KVM](https://github.com/pikvm/pikvm) ⭐ 10,343 | 🐛 89 | 📅 2026-09-10 - DIY KVM over IP to manage remote computers via Web UI or VNC with FullHD video, mouse, virtual drive, IPMI, Wake-on-LAN and many other things.
...
* [Smart Mirror](https://github.com/evancohen/smart-mirror) ⭐ 2,821 | 🐛 14 | 🌐 JavaScript | 📅 2026-09-17 - Voice controlled smart mirror with IoT integration. ![Supports Raspberry Pi 2+](/media/badges/rpi-2+.png)
* [Circle](https://github.com/rsta2/circle) ⭐ 2,303 | 🐛 15 | 🌐 C | 📅 2026-09-14 - A C++ bare metal environment for Raspberry Pi.
...
* [PiFmRds](https://github.com/ChristopheJacquet/PiFmRds) ⭐ 1,590 | 🐛 69 | 🌐 C | 📅 2026-02-01 - FM-RDS transmitter using a Raspberry Pi.
* [CookCLI](https://github.com/cooklang/CookCLI) ⭐ 1,387 | 🐛 33 | 🌐 Rust | 📅 2026-09-17 - Turn your Raspberry Pi into a self-hosted recipe server. Manage recipes in plain-text Cooklang format with web UI, shopping lists, and meal planning.
...
* [speed-camera](https://github.com/pageauc/speed-camera) ⭐ 1,105 | 🐛 20 | 🌐 Python | 📅 2025-10-17 - Object Motion Tracking uses python, openCV, USB Cam or picamera module to record speed data.
...
* [RustChain](https://github.com/Scottcjn/Rustchain) ⭐ 808 | 🐛 157 | 🌐 Python | 📅 2026-09-18 - Proof-of-Antiquity blockchain that rewards vintage and edge hardware including Raspberry Pi for mining. DePIN infrastructure for IoT devices.
* [Haven](https://github.com/havenweb/haven) ⭐ 803 | 🐛 17 | 🌐 Ruby | 📅 2026-09-17 - Host a private blog on your Rasperry Pi instead of using Facebook.
...
* [DCS-BIOS](https://github.com/DCS-Skunkworks/dcs-bios) ⭐ 432 | 🐛 157 | 🌐 Lua | 📅 2026-09-17 - Exports DCS World cockpit data (switches, lights, displays) over serial/UDP to Arduino, ESP32, or Raspberry Pi for physical panel builds.
...
* [Lomorage](https://github.com/lomorage/homepage) ⭐ 239 | 🐛 6 | 🌐 HTML | 📅 2026-09-18 - Private photo cloud host on Raspberry Pi, with Android/iOS/Web client.
...
* [ble-scale-sync](https://github.com/KristianP26/ble-scale-sync) ⭐ 174 | 🐛 14 | 🌐 TypeScript | 📅 2026-09-14 - Reads BLE smart scales (23 brands) via built-in Bluetooth, calculates body composition, and exports to Garmin Connect, MQTT/Home Assistant, InfluxDB, and more. [Website](https://blescalesync.dev).
...
* [NanoBot AI Chat Robot](https://github.com/samartzidis/NanoBot) ⭐ 4 | 🐛 0 | 🌐 C# | 📅 2026-09-17 - Raspberry Pi powered AI chat robot, ideal for education and teaching assistance.
...
Contribution guidelines can be found [here](https://github.com/thibmaek/awesome-raspberry-pi/blob/main/CONTRIBUTING.md) ⭐ 16,885 | 🐛 28 | 🌐 Shell | 📅 2026-07-27
