...
* [pi-gen](https://github.com/RPi-Distro/pi-gen) ⭐ 3,241 | 🐛 169 | 🌐 Shell | 📅 2026-06-19 - Tool used to create the raspberrypi.org Raspbian images. This can be used to create your own custom images with specific packages installed, etc.
* [Pi-Apps](https://github.com/Botspot/pi-apps) ⭐ 2,794 | 🐛 150 | 🌐 Shell | 📅 2026-08-28 - The most popular app store for Raspberry Pi computers, 100% open-source bash scripts.
...
* [Circle](https://github.com/rsta2/circle) ⭐ 2,297 | 🐛 13 | 🌐 C | 📅 2026-08-26 - A C++ bare metal environment for Raspberry Pi.
...
* [CookCLI](https://github.com/cooklang/CookCLI) ⭐ 1,376 | 🐛 26 | 🌐 Rust | 📅 2026-08-28 - Turn your Raspberry Pi into a self-hosted recipe server. Manage recipes in plain-text Cooklang format with web UI, shopping lists, and meal planning.
...
* [RustChain](https://github.com/Scottcjn/Rustchain) ⭐ 731 | 🐛 191 | 🌐 Python | 📅 2026-08-29 - Proof-of-Antiquity blockchain that rewards vintage and edge hardware including Raspberry Pi for mining. DePIN infrastructure for IoT devices.
...
* [ble-scale-sync](https://github.com/KristianP26/ble-scale-sync) ⭐ 161 | 🐛 14 | 🌐 TypeScript | 📅 2026-08-28 - Reads BLE smart scales (23 brands) via built-in Bluetooth, calculates body composition, and exports to Garmin Connect, MQTT/Home Assistant, InfluxDB, and more. [Website](https://blescalesync.dev).
* [Movel](https://github.com/stevelacy/movel) ⭐ 156 | 🐛 1 | 🌐 CoffeeScript | 📅 2015-12-21 - Raspberry Pi car computer.
* [BotWave](https://github.com/dpipstudio/botwave/) ⭐ 140 | 🐛 0 | 🌐 Python | 📅 2026-08-27 - FM broadcasting system with server-client architecture for managing multiple Raspberry Pi transmitters remotely. ![Supports Raspberry Pi Zero](/media/badges/rpi-0.png) ![Supports Raspberry Pi 2](/media/badges/rpi-2.png) ![Supports Raspberry Pi 3](/media/badges/rpi-3.png)
