...
[![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 503,734 | 🐛 106 | 📅 2026-09-02
[![All Contributors](https://img.shields.io/badge/all_contributors-43-orange.svg)](https://github.com/thibmaek/awesome-raspberry-pi/blob/main/CONTRIBUTORS.md) ⭐ 16,839 | 🐛 23 | 🌐 Shell | 📅 2026-07-27
...
This list is a collection of tools, projects, images and resources conforming to the [Awesome Manifesto](https://github.com/sindresorhus/awesome/blob/main/awesome.md) ⭐ 503,734 | 🐛 106 | 📅 2026-09-02
...
* [NextCloudPi](https://github.com/nextcloud/nextcloudpi) ⭐ 2,938 | 🐛 230 | 🌐 Shell | 📅 2026-09-06 - Nextcloud ready image based on Raspbian. Features Nextcloud 11 running on Raspbian 8, with PHP 7 and HTTP2 enabled Apache server.
...
* [Mainsail OS](https://github.com/mainsail-crew/MainsailOS) ⭐ 745 | 🐛 4 | 🌐 Shell | 📅 2026-05-14 - A distribution for 3D Printers that includes everything to get started with Klipper Firmware and Mainsail.
...
* [pi-gen](https://github.com/RPi-Distro/pi-gen) ⭐ 3,246 | 🐛 170 | 🌐 Shell | 📅 2026-06-19 - Tool used to create the raspberrypi.org Raspbian images. This can be used to create your own custom images with specific packages installed, etc.
* [Pi-Apps](https://github.com/Botspot/pi-apps) ⭐ 2,804 | 🐛 151 | 🌐 Shell | 📅 2026-09-06 - The most popular app store for Raspberry Pi computers, 100% open-source bash scripts.
...
* [AdGuard Home](https://github.com/AdguardTeam/AdGuardHome) ⭐ 36,733 | 🐛 1,246 | 🌐 TypeScript | 📅 2026-09-07 - DNS relay station with ad/tracker/other blocking, IP address redirections, and DNS-over-HTTPS.
* [Sonic Pi](https://github.com/samaaron/sonic-pi) ⭐ 12,118 | 🐛 26 | 🌐 C++ | 📅 2026-08-12 - The Live Coding Music Synth for Everyone.
* [Pi-KVM](https://github.com/pikvm/pikvm) ⭐ 10,304 | 🐛 89 | 📅 2026-08-29 - DIY KVM over IP to manage remote computers via Web UI or VNC with FullHD video, mouse, virtual drive, IPMI, Wake-on-LAN and many other things.
...
* [Secluso](https://github.com/secluso/core) ⭐ 1,662 | 🐛 36 | 🌐 Rust | 📅 2026-08-24 - A private-by-default Raspberry Pi home security camera that uses end-to-end encryption. Supports Raspberry Pi Zero 2 W. ![Supports Raspberry Pi 2+](/media/badges/rpi-2+.png)
* [PiFmRds](https://github.com/ChristopheJacquet/PiFmRds) ⭐ 1,590 | 🐛 69 | 🌐 C | 📅 2026-02-01 - FM-RDS transmitter using a Raspberry Pi.
* [CookCLI](https://github.com/cooklang/CookCLI) ⭐ 1,379 | 🐛 28 | 🌐 Rust | 📅 2026-09-06 - Turn your Raspberry Pi into a self-hosted recipe server. Manage recipes in plain-text Cooklang format with web UI, shopping lists, and meal planning.
...
* [speed-camera](https://github.com/pageauc/speed-camera) ⭐ 1,103 | 🐛 20 | 🌐 Python | 📅 2025-10-17 - Object Motion Tracking uses python, openCV, USB Cam or picamera module to record speed data.
...
* [Haven](https://github.com/havenweb/haven) ⭐ 801 | 🐛 17 | 🌐 Ruby | 📅 2026-08-11 - Host a private blog on your Rasperry Pi instead of using Facebook.
* [RustChain](https://github.com/Scottcjn/Rustchain) ⭐ 765 | 🐛 155 | 🌐 Python | 📅 2026-09-06 - Proof-of-Antiquity blockchain that rewards vintage and edge hardware including Raspberry Pi for mining. DePIN infrastructure for IoT devices.
...
* [DCS-BIOS](https://github.com/DCS-Skunkworks/dcs-bios) ⭐ 428 | 🐛 145 | 🌐 Lua | 📅 2026-09-06 - Exports DCS World cockpit data (switches, lights, displays) over serial/UDP to Arduino, ESP32, or Raspberry Pi for physical panel builds.
...
* [ble-scale-sync](https://github.com/KristianP26/ble-scale-sync) ⭐ 167 | 🐛 12 | 🌐 TypeScript | 📅 2026-09-06 - Reads BLE smart scales (23 brands) via built-in Bluetooth, calculates body composition, and exports to Garmin Connect, MQTT/Home Assistant, InfluxDB, and more. [Website](https://blescalesync.dev).
...
Contribution guidelines can be found [here](https://github.com/thibmaek/awesome-raspberry-pi/blob/main/CONTRIBUTING.md) ⭐ 16,839 | 🐛 23 | 🌐 Shell | 📅 2026-07-27
